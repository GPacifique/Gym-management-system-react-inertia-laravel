...
Route::get(
    ...
    [MemberPaymentController::class, 'receipt']
)->name('payments.receipt');
Route::resource('receipts', MemberReceiptController::class);
Route::get(
    'receipts/{receipt}/print',
    [MemberReceiptController::class, 'print']
)->name('receipts.print');
